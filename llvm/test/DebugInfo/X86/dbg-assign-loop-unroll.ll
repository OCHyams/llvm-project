...
for.body:                                         ; preds = %entry
  store i32 0, i32* %p.addr, align 4, !dbg !24, !tbaa !15, !DIAssignID !27
  call void @llvm.dbg.assign(metadata i32 0, metadata !12, metadata !DIExpression(), metadata !27, metadata i32* %p.addr), !dbg !24
  call void @_Z3escPi(i32* nonnull %p.addr), !dbg !28
  call void @llvm.dbg.assign(metadata i32 1, metadata !13, metadata !DIExpression(), metadata !29, metadata i32* undef), !dbg !30
  store i32 1, i32* %p.addr, align 4, !dbg !24, !tbaa !15, !DIAssignID !27
  call void @llvm.dbg.assign(metadata i32 1, metadata !12, metadata !DIExpression(), metadata !27, metadata i32* %p.addr), !dbg !24
  call void @_Z3escPi(i32* nonnull %p.addr), !dbg !28
  call void @llvm.dbg.assign(metadata i32 2, metadata !13, metadata !DIExpression(), metadata !29, metadata i32* undef), !dbg !30
  ret void, !dbg !31
}

declare !dbg !32 dso_local void @_Z3escPi(i32*) local_unnamed_addr
