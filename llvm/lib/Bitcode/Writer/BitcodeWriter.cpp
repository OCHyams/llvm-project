...
void ModuleBitcodeWriter::writeBlockInfo() {
  ...
  }
  {
    ...
    Abbv->Add(BitCodeAbbrevOp(BitCodeAbbrevOp::VBR, 16)); // dbgloc
    Abbv->Add(BitCodeAbbrevOp(BitCodeAbbrevOp::VBR, 16)); // var
    Abbv->Add(BitCodeAbbrevOp(BitCodeAbbrevOp::VBR, 16)); // expr
