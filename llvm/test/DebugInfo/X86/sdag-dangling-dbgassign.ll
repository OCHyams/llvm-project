...
entry1:
  call void @llvm.dbg.assign(metadata %struct.SS* @S, metadata !20, metadata !DIExpression(), metadata !54, metadata %struct.SS** undef), !dbg !23
  call void @llvm.dbg.assign(metadata %struct.SS* null, metadata !22, metadata !DIExpression(), metadata !54, metadata %struct.SS** undef), !dbg !24
...
entry2:
  call void @llvm.dbg.assign(metadata %struct.SS* @S, metadata !28, metadata !DIExpression(), metadata !54, metadata %struct.SS** undef), !dbg !30
  call void @llvm.dbg.assign(metadata %struct.SS* @S, metadata !29, metadata !DIExpression(), metadata !54, metadata %struct.SS** undef), !dbg !31
...
entry3:
  call void @llvm.dbg.assign(metadata %struct.SS* @S, metadata !36, metadata !DIExpression(), metadata !54, metadata %struct.SS** undef), !dbg !38
  call void @llvm.dbg.assign(metadata %struct.SS* @S, metadata !35, metadata !DIExpression(), metadata !54, metadata %struct.SS** undef), !dbg !37
...
entry4:
  call void @llvm.dbg.assign(metadata %struct.SS* @S, metadata !42, metadata !DIExpression(), metadata !54, metadata %struct.SS** undef), !dbg !44
  call void @llvm.dbg.assign(metadata %struct.SS* @S, metadata !43, metadata !DIExpression(), metadata !54, metadata %struct.SS** undef), !dbg !45
  call void @llvm.dbg.assign(metadata %struct.SS* null, metadata !42, metadata !DIExpression(), metadata !54, metadata %struct.SS** undef), !dbg !44
...
; CHECK:         RET
entry5:
  call void @llvm.dbg.assign(metadata %struct.SS* @S, metadata !49, metadata !DIExpression(), metadata !54, metadata %struct.SS** undef), !dbg !51
  call void @llvm.dbg.assign(metadata %struct.SS* @S, metadata !50, metadata !DIExpression(), metadata !54, metadata %struct.SS** undef), !dbg !52
  call void @llvm.dbg.assign(metadata %struct.SS* null, metadata !50, metadata !DIExpression(), metadata !54, metadata %struct.SS** undef), !dbg !52
