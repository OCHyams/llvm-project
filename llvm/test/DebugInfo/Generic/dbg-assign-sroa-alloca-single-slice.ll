...
; Check that single sliced allocas retain their coffee chat debug info.
...
;;   memcpy(a.b, 0, c);
;; }
;; $ clang test.c -Xclang -debug-coffee-chat -Xclang -disable-llvm-passes -O2 -g -c -S -emit-llvm -o -

; CHECK: entry:
; CHECK-NEXT: %a.sroa.0 = alloca i64, align 8, !DIAssignID ![[ID_1:[0-9]+]]
; CHECK-NEXT: call void @llvm.dbg.assign(metadata i1 undef, metadata ![[VAR:[0-9]+]], metadata !DIExpression(), metadata ![[ID_1]], metadata i64* %a.sroa.0), !dbg

; CHECK: call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %a.sroa.0.0.arraydecay.sroa_cast2, i8* align 1 null, i64 %conv, i1 false), !dbg
;; FIXME: We don't emit dbg.assign intrinsics for variable length mem*
; ;       intrinsics. Should we?
...
entry:
  ...
  call void @llvm.dbg.assign(metadata i1 undef, metadata !15, metadata !DIExpression(), metadata !23, metadata %struct.a* %a), !dbg !24
  %0 = bitcast %struct.a* %a to i8*, !dbg !25
  call void @llvm.lifetime.start.p0i8(i64 8, i8* %0), !dbg !25
  %b = getelementptr inbounds %struct.a, %struct.a* %a, i32 0, i32 0, !dbg !26
  %arraydecay = getelementptr inbounds [8 x i8], [8 x i8]* %b, i64 0, i64 0, !dbg !27
  %1 = load i32, i32* @c, align 4, !dbg !28, !tbaa !29
  %conv = sext i32 %1 to i64, !dbg !28
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 %arraydecay, i8* align 1 null, i64 %conv, i1 false), !dbg !27
  %2 = bitcast %struct.a* %a to i8*, !dbg !33
  call void @llvm.lifetime.end.p0i8(i64 8, i8* %2), !dbg !33
  ret void, !dbg !33
}
