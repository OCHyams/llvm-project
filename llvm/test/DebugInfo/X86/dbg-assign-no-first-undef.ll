; RUN: llc %s -o - -stop-after=finalize-isel | FileCheck %s --implicit-check-not=DBG_VALUE
...
entry:
  ...
  call void (...) @a(), !dbg !16
  call void @llvm.dbg.assign(metadata i1 undef, metadata !11, metadata !DIExpression(), metadata !10, metadata i8* %c), !dbg !13
  ret void, !dbg !17
}
