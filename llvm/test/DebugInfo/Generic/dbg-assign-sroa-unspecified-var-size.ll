...
; CHECK: @llvm.dbg.assign(metadata i8* %0,{{.+}}, metadata !DIExpression(),{{.+}}, metadata i8** undef)
;; There should be no new fragment and the value component should remain as %0.

define dso_local void @_Z3funDn(i8* %0) #0 !dbg !14 {
entry:
  %.addr = alloca i8*, align 8, !DIAssignID !22
  call void @llvm.dbg.assign(metadata i1 undef, metadata !21, metadata !DIExpression(), metadata !22, metadata i8** %.addr), !dbg !23
  store i8* %0, i8** %.addr, align 8, !tbaa !24
  store i8* %0, i8** %.addr, align 8, !tbaa !24, !DIAssignID !28
  call void @llvm.dbg.assign(metadata i8* %0, metadata !21, metadata !DIExpression(), metadata !28, metadata i8** %.addr), !dbg !23
  ret void, !dbg !29
}
...
!7 = !DIFile(filename: "llvm/coffee-chat/build-rel/lib/clang/12.0.0/include/__stddef_max_align_t.h", directory: "/home/och/dev")
!8 = !DICompositeType(tag: DW_TAG_structure_type, file: !7, line: 19, size: 256, flags: DIFlagFwdDecl, identifier: "_ZTS11max_align_t")
!9 = !DIFile(filename: "/usr/lib/gcc/x86_64-linux-gnu/7.5.0/../../../../include/c++/7.5.0/cstddef", directory: "")
...
!18 = !DIFile(filename: "/usr/lib/gcc/x86_64-linux-gnu/7.5.0/../../../../include/x86_64-linux-gnu/c++/7.5.0/bits/c++config.h", directory: "")
