...
;; Check that the frag-agg pseudo-pass works on a simple case. When LLVM sees a
...
; CHECK: DBG_VALUE %stack.0.nums, $noreg, ![[nums]], !DIExpression(DW_OP_deref)
  call void @llvm.dbg.assign(metadata i1 undef, metadata !12, metadata !DIExpression(), metadata !18, metadata %struct.Nums* %nums), !dbg !19
  %0 = bitcast %struct.Nums* %nums to i8*, !dbg !20
  call void @llvm.lifetime.start.p0i8(i64 12, i8* nonnull %0) #4, !dbg !20
  %1 = bitcast %struct.Nums* %nums to i64*, !dbg !21
  store i64 8589934593, i64* %1, align 8, !dbg !21, !DIAssignID !22
; CHECK: MOV64mr %stack.0.nums, 1, $noreg, 0, $noreg, killed %0
  call void @llvm.dbg.assign(metadata i1 undef, metadata !12, metadata !DIExpression(), metadata !22, metadata i8* %0), !dbg !19
  call void @llvm.dbg.assign(metadata i1 undef, metadata !12, metadata !DIExpression(DW_OP_LLVM_fragment, 64, 32), metadata !22, metadata i8* undef), !dbg !19
; CHECK-NEXT: DBG_VALUE $noreg, $noreg, ![[nums]], !DIExpression(DW_OP_deref, DW_OP_LLVM_fragment, 64, 32)
; CHECK-NEXT: DBG_VALUE %stack.0.nums, $noreg, ![[nums]], !DIExpression(DW_OP_deref, DW_OP_LLVM_fragment, 0, 64)
  ...
  %c = getelementptr inbounds %struct.Nums, %struct.Nums* %nums, i64 0, i32 2, !dbg !24
  store i32 2, i32* %c, align 8, !dbg !25, !tbaa !26, !DIAssignID !31
; CHECK: MOV32mi %stack.0.nums, 1, $noreg, 8, $noreg, 2
  call void @llvm.dbg.assign(metadata i32 2, metadata !12, metadata !DIExpression(DW_OP_LLVM_fragment, 64, 32), metadata !31, metadata i32* %c), !dbg !19
; CHECK-NEXT: DBG_VALUE %stack.0.nums, $noreg, ![[nums]], !DIExpression(DW_OP_plus_uconst, 8, DW_OP_deref, DW_OP_LLVM_fragment, 64, 32)
  ...
  call void @_Z3escP4Nums(%struct.Nums* noundef nonnull %nums), !dbg !33
  call void @llvm.lifetime.end.p0i8(i64 12, i8* nonnull %0) #4, !dbg !34
  ret i32 0, !dbg !35
}

declare void @llvm.lifetime.start.p0i8(i64 immarg, i8* nocapture) #1
declare !dbg !36 dso_local void @_Z4stepv() local_unnamed_addr #2
declare !dbg !40 dso_local void @_Z3escP4Nums(%struct.Nums* noundef) local_unnamed_addr #2
...
!26 = !{!27, !28, i64 8}
!27 = !{!"_ZTS4Nums", !28, i64 0, !28, i64 4, !28, i64 8}
!28 = !{!"int", !29, i64 0}
