...
entry:
  ...
  call void @llvm.dbg.assign(metadata i32 5, metadata !11, metadata !DIExpression(), metadata !30, metadata i32* %local), !dbg !16
  store i32 6, i32* %local, align 4, !dbg !23, !DIAssignID !31
  call void @llvm.dbg.assign(metadata i32 6, metadata !11, metadata !DIExpression(), metadata !31, metadata i32* %local), !dbg !16
  call void @esc(i32* nonnull %local), !dbg !24
  ret void, !dbg !25
}

declare void @llvm.dbg.assign(metadata, metadata, metadata, metadata, metadata)

declare !dbg !26 dso_local void @esc(i32*) local_unnamed_addr
