...
void ConvertDebugDeclareToDebugValue(DbgVariableRecord *DPV, StoreInst *SI,
                                     DIBuilder &Builder);
...
void ConvertDebugDeclareToDebugValue(DbgVariableRecord *DPV, LoadInst *LI,
                                     DIBuilder &Builder);
...
void ConvertDebugDeclareToDebugValue(DbgVariableRecord *DPV, PHINode *LI,
                                     DIBuilder &Builder);
