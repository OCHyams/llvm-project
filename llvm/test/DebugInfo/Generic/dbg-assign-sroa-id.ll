...
; CHECK-NEXT: call void @llvm.dbg.assign(metadata float %storemerge, metadata ![[var:[0-9]+]], metadata !DIExpression(), metadata ![[id:[0-9]+]], metadata float* undef), !dbg ![[dbg:[0-9]+]]

; CHECK: if.else:
; CHECK-NEXT: %2 = load float
; CHECK-NEXT: %3 = load float
; CHECK-NEXT: %div = fdiv float
; CHECK: call void @llvm.dbg.assign(metadata float %storemerge, metadata ![[var]], metadata !DIExpression(), metadata ![[id]], metadata float* undef), !dbg ![[dbg]]
...
entry:
  ...
  call void @llvm.dbg.assign(metadata i1 undef, metadata !20, metadata !DIExpression(), metadata !21, metadata float* %e), !dbg !22
  %agg.tmp.ensured = alloca %class.a, align 1
  %0 = bitcast float* %e to i8*, !dbg !23
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %0) #4, !dbg !23
  %1 = load i32, i32* @c, align 4, !dbg !24, !tbaa !26
  %tobool.not = icmp eq i32 %1, 0, !dbg !24
  br i1 %tobool.not, label %if.else, label %if.then, !dbg !30

if.then:                                          ; preds = %entry
  %2 = load float, float* @b, align 4, !dbg !31, !tbaa !32
  call void @llvm.dbg.assign(metadata float %2, metadata !20, metadata !DIExpression(), metadata !34, metadata float* %e), !dbg !22
  br label %if.end, !dbg !35

if.else:                                          ; preds = %entry
  %3 = load float, float* @b, align 4, !dbg !36, !tbaa !32
  %4 = load float, float* @d, align 4, !dbg !37, !tbaa !32
  %div = fdiv float %3, %4, !dbg !38
  call void @llvm.dbg.assign(metadata float %div, metadata !20, metadata !DIExpression(), metadata !34, metadata float* %e), !dbg !22
  br label %if.end

if.end:                                           ; preds = %if.else, %if.then
  %storemerge = phi float [ %div, %if.else ], [ %2, %if.then ], !dbg !39
  store float %storemerge, float* %e, align 4, !dbg !39, !tbaa !32, !DIAssignID !34
  %5 = load i32, i32* @c, align 4, !dbg !40, !tbaa !26
  call void @llvm.dbg.assign(metadata i1 undef, metadata !41, metadata !DIExpression(), metadata !54, metadata %class.a** undef), !dbg !55
  call void @llvm.dbg.assign(metadata i1 undef, metadata !51, metadata !DIExpression(), metadata !57, metadata i32* undef), !dbg !55
  call void @llvm.dbg.assign(metadata i1 undef, metadata !52, metadata !DIExpression(), metadata !58, metadata float** undef), !dbg !55
  call void @llvm.dbg.assign(metadata %class.a* %agg.tmp.ensured, metadata !41, metadata !DIExpression(), metadata !59, metadata %class.a** undef), !dbg !55
  call void @llvm.dbg.assign(metadata i32 %5, metadata !51, metadata !DIExpression(), metadata !60, metadata i32* undef), !dbg !55
  call void @llvm.dbg.assign(metadata float* %e, metadata !52, metadata !DIExpression(), metadata !61, metadata float** undef), !dbg !55
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %0) #4, !dbg !62
  ret void, !dbg !62
}
...
define linkonce_odr dso_local void @_ZN1aC2EiRf(%class.a* %this, i32 %0, float* nonnull align 4 dereferenceable(4) %1) unnamed_addr #2 comdat align 2 !dbg !42 {
entry:
  call void @llvm.dbg.assign(metadata i1 undef, metadata !41, metadata !DIExpression(), metadata !63, metadata %class.a** undef), !dbg !64
  call void @llvm.dbg.assign(metadata i1 undef, metadata !51, metadata !DIExpression(), metadata !65, metadata i32* undef), !dbg !64
  call void @llvm.dbg.assign(metadata i1 undef, metadata !52, metadata !DIExpression(), metadata !66, metadata float** undef), !dbg !64
  call void @llvm.dbg.assign(metadata %class.a* %this, metadata !41, metadata !DIExpression(), metadata !67, metadata %class.a** undef), !dbg !64
  call void @llvm.dbg.assign(metadata i32 %0, metadata !51, metadata !DIExpression(), metadata !68, metadata i32* undef), !dbg !64
  call void @llvm.dbg.assign(metadata float* %1, metadata !52, metadata !DIExpression(), metadata !69, metadata float** undef), !dbg !64
  ret void, !dbg !70
}
