...
;; This slice has been promoted, so the alloca has gone away.
...
; CHECK-NEXT:   call void @llvm.dbg.assign(metadata i1 undef, metadata ![[VAR]], metadata !DIExpression(DW_OP_LLVM_fragment, 128, 96), metadata ![[ID_3]], metadata { i32, i32, i32 }* %S.sroa.5), !dbg

;; The memset has been sliced up.
; CHECK: call void @llvm.memset.p0i8.i64(i8* align 8 %S.sroa.0.0..sroa_cast13, i8 0, i64 12, i1 false), !dbg !{{.+}}, !DIAssignID ![[ID_5:[0-9]+]]
; CHECK-NEXT:   call void @llvm.dbg.assign(metadata i8 0, metadata ![[VAR]], metadata !DIExpression(DW_OP_LLVM_fragment, 0, 96), metadata ![[ID_5]], metadata i8* %S.sroa.0.0..sroa_cast13), !dbg
;;
...
;;
; CHECK: call void @llvm.memset.p0i8.i64(i8* align 8 %S.sroa.5.0..sroa_cast8, i8 0, i64 12, i1 false), !dbg !{{.+}}, !DIAssignID ![[ID_6:[0-9]+]]
; CHECK-NEXT:   call void @llvm.dbg.assign(metadata i8 0, metadata ![[VAR]], metadata !DIExpression(DW_OP_LLVM_fragment, 128, 96), metadata ![[ID_6]], metadata i8* %S.sroa.5.0..sroa_cast8), !dbg
;;
;; mem2reg promotes the load/store to the middle slice created by SROA:
; CHECK-NEXT: %0 = load i32, i32* @Glob, align 4, !dbg !{{.+}}, !tbaa
; CHECK-NEXT: call void @llvm.dbg.assign(metadata i32 %0, metadata ![[VAR]], metadata !DIExpression(DW_OP_LLVM_fragment, 96, 32), metadata ![[ID_4:[0-9]+]], metadata i32* undef), !dbg
...
entry:
  ...
  call void @llvm.lifetime.start.p0i8(i64 28, i8* %0) #4, !dbg !30
  ...
  %Var1 = getelementptr inbounds %struct.LargeStruct, %struct.LargeStruct* %S, i32 0, i32 3, !dbg !43
  %3 = load i32, i32* %Var1, align 4, !dbg !43, !tbaa !40
  %4 = bitcast %struct.LargeStruct* %S to i8*, !dbg !44
  call void @llvm.lifetime.end.p0i8(i64 28, i8* %4) #4, !dbg !44
  ret i32 %3, !dbg !45
}
