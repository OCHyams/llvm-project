...
entry:
  ...
  call void @llvm.dbg.assign(metadata i1 undef, metadata !11, metadata !DIExpression(), metadata !13, metadata i64* %c), !dbg !14
  call void @llvm.lifetime.start.p0i64(i64 1, i64* nonnull %c) #4, !dbg !15
  store i64 5, i64* %c, align 1, !dbg !16, !tbaa !17, !DIAssignID !20
  call void @llvm.dbg.assign(metadata i64 5, metadata !11, metadata !DIExpression(), metadata !20, metadata i64* %c), !dbg !14
  tail call void (...) @d() #4, !dbg !21

  ; --- VV  Hand written  VV --- ;
  %bc = bitcast i64* %c to i32*
  store i32 1, i32* %bc, align 1, !dbg !16, !tbaa !17, !DIAssignID !31
  ...
  tail call void (...) @d() #4, !dbg !21
  call void @llvm.dbg.assign(metadata i32 1, metadata !11, metadata !DIExpression(DW_OP_LLVM_fragment, 0, 32), metadata !31, metadata i32* %bc), !dbg !14
  ; --- AA  Hand written  AA --- ;
