...
;; Check that the fragments generated in SROA for a split alloca that
;; has a dbg.assign with non-zero-offset fragment already are correct.
...
;; }
;; $ clang++ -c -O2 -g test.cpp -Xclang -debug-coffee-chat  -o - -Xclang -disable-llvm-passes -S -emit-llvm

; CHECK: entry:
;; Allocas have been promoted, there are a bunch of unlinked dbg.assign
;; intrinsics left over.
; CHECK-NEXT: call void @llvm.dbg.assign(metadata i1 undef, metadata ![[point:[0-9]+]], metadata !DIExpression(DW_OP_LLVM_fragment, 0, 64), metadata !{{.+}}, metadata i64* undef), !dbg
; CHECK-NEXT: call void @llvm.dbg.assign(metadata i1 undef, metadata ![[point]], metadata !DIExpression(DW_OP_LLVM_fragment, 64, 64), metadata !{{.+}}, metadata i64* undef), !dbg
; CHECK-NEXT: call void @llvm.dbg.assign(metadata i1 undef, metadata ![[point]], metadata !DIExpression(DW_OP_LLVM_fragment, 128, 64), metadata !{{.+}}, metadata i64* undef), !dbg
; CHECK-NEXT: call void @llvm.dbg.assign(metadata i1 undef, metadata ![[other:[0-9]+]], metadata !DIExpression(DW_OP_LLVM_fragment, 0, 64), metadata !{{.+}}, metadata i64* undef), !dbg
; CHECK-NEXT: call void @llvm.dbg.assign(metadata i1 undef, metadata ![[other]], metadata !DIExpression(DW_OP_LLVM_fragment, 64, 64), metadata !{{.+}}, metadata i64* undef), !dbg
; CHECK-NEXT: call void @llvm.dbg.assign(metadata i1 undef, metadata ![[other]], metadata !DIExpression(DW_OP_LLVM_fragment, 128, 64), metadata !{{.+}}, metadata i64* undef), !dbg

;; | V3i point = {0, 0, 0};
; CHECK-NEXT: call void @llvm.dbg.assign(metadata i64 0, metadata ![[point]], metadata !DIExpression(DW_OP_LLVM_fragment, 0, 64), metadata !{{.+}}, metadata i64* undef), !dbg
; CHECK-NEXT: call void @llvm.dbg.assign(metadata i64 0, metadata ![[point]], metadata !DIExpression(DW_OP_LLVM_fragment, 64, 64), metadata !{{.+}}, metadata i64* undef), !dbg
; CHECK-NEXT: call void @llvm.dbg.assign(metadata i64 0, metadata ![[point]], metadata !DIExpression(DW_OP_LLVM_fragment, 128, 64), metadata !{{.+}}, metadata i64* undef), !dbg

;; point.z = 5000;
; CHECK-NEXT: call void @llvm.dbg.assign(metadata i64 5000, metadata ![[point]], metadata !DIExpression(DW_OP_LLVM_fragment, 128, 64), metadata !{{.+}}, metadata i64* undef), !dbg

;; | V3i other = {10, 9, 8};
;;   other is global const:
;;     local.other.x = global.other.x
; CHECK-NEXT: %other.sroa.0.0.copyload = load i64, i64* getelementptr inbounds (%struct.V3i, %struct.V3i* @__const._Z3funv.other, i64 0, i32 0), align 8, !dbg
; CHECK-NEXT: call void @llvm.dbg.assign(metadata i64 %other.sroa.0.0.copyload, metadata ![[other]], metadata !DIExpression(DW_OP_LLVM_fragment, 0, 64), metadata !{{.+}}, metadata i64* undef), !dbg
;;
;;     local.other.y = global.other.y
; CHECK-NEXT: %other.sroa.4.0.copyload = load i64, i64* getelementptr inbounds (%struct.V3i, %struct.V3i* @__const._Z3funv.other, i64 0, i32 1), align 8, !dbg
; CHECK-NEXT: call void @llvm.dbg.assign(metadata i64 %other.sroa.4.0.copyload, metadata ![[other]], metadata !DIExpression(DW_OP_LLVM_fragment, 64, 64), metadata !{{.+}}, metadata i64* undef), !dbg
;;
;;     local.other.z = global.other.z
; CHECK-NEXT: %other.sroa.5.0.copyload = load i64, i64* getelementptr inbounds (%struct.V3i, %struct.V3i* @__const._Z3funv.other, i64 0, i32 2), align 8, !dbg
; CHECK-NEXT: call void @llvm.dbg.assign(metadata i64 %other.sroa.5.0.copyload, metadata ![[other]], metadata !DIExpression(DW_OP_LLVM_fragment, 128, 64), metadata !{{.+}}, metadata i64* undef), !dbg

;; | std::memcpy(&point.y, &other.x, sizeof(long) * 2);
;;   other is now 3 scalars:
;;     point.y = other.x
; CHECK-NEXT: call void @llvm.dbg.assign(metadata i64 %other.sroa.0.0.copyload, metadata ![[point]], metadata !DIExpression(DW_OP_LLVM_fragment, 64, 64), metadata !{{.+}}, metadata i64* undef), !dbg
;;
;;     point.z = other.y
; CHECK-NEXT: call void @llvm.dbg.assign(metadata i64 %other.sroa.4.0.copyload, metadata ![[point]], metadata !DIExpression(DW_OP_LLVM_fragment, 128, 64), metadata !{{.+}}, metadata i64* undef), !dbg
...
entry:
  ...
  call void @llvm.dbg.assign(metadata i1 undef, metadata !104, metadata !DIExpression(), metadata !112, metadata %struct.V3i* %point), !dbg !113
  %other = alloca %struct.V3i, align 8, !DIAssignID !114
  call void @llvm.dbg.assign(metadata i1 undef, metadata !111, metadata !DIExpression(), metadata !114, metadata %struct.V3i* %other), !dbg !113
  %0 = bitcast %struct.V3i* %point to i8*, !dbg !115
  call void @llvm.lifetime.start.p0i8(i64 24, i8* %0), !dbg !115
  %1 = bitcast %struct.V3i* %point to i8*, !dbg !116
  call void @llvm.memset.p0i8.i64(i8* align 8 %1, i8 0, i64 24, i1 false), !dbg !116, !DIAssignID !117
  call void @llvm.dbg.assign(metadata i8 0, metadata !104, metadata !DIExpression(), metadata !117, metadata i8* %1), !dbg !116
  %z = getelementptr inbounds %struct.V3i, %struct.V3i* %point, i32 0, i32 2, !dbg !118
  store i64 5000, i64* %z, align 8, !dbg !119, !tbaa !120, !DIAssignID !125
  call void @llvm.dbg.assign(metadata i64 5000, metadata !104, metadata !DIExpression(DW_OP_LLVM_fragment, 128, 64), metadata !125, metadata i64* %z), !dbg !119
  %2 = bitcast %struct.V3i* %other to i8*, !dbg !126
  call void @llvm.lifetime.start.p0i8(i64 24, i8* %2), !dbg !126
  %3 = bitcast %struct.V3i* %other to i8*, !dbg !127
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %3, i8* align 8 bitcast (%struct.V3i* @__const._Z3funv.other to i8*), i64 24, i1 false), !dbg !127, !DIAssignID !128
  call void @llvm.dbg.assign(metadata i1 undef, metadata !111, metadata !DIExpression(), metadata !128, metadata i8* %3), !dbg !127
  %y = getelementptr inbounds %struct.V3i, %struct.V3i* %point, i32 0, i32 1, !dbg !129
  %4 = bitcast i64* %y to i8*, !dbg !130
  %x = getelementptr inbounds %struct.V3i, %struct.V3i* %other, i32 0, i32 0, !dbg !131
  %5 = bitcast i64* %x to i8*, !dbg !130
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %4, i8* align 8 %5, i64 16, i1 false), !dbg !130, !DIAssignID !132
  call void @llvm.dbg.assign(metadata i1 undef, metadata !104, metadata !DIExpression(DW_OP_LLVM_fragment, 64, 128), metadata !132, metadata i8* %4), !dbg !130
  %6 = bitcast %struct.V3i* %other to i8*, !dbg !133
  call void @llvm.lifetime.end.p0i8(i64 24, i8* %6), !dbg !133
  %7 = bitcast %struct.V3i* %point to i8*, !dbg !133
  call void @llvm.lifetime.end.p0i8(i64 24, i8* %7), !dbg !133
  ret void, !dbg !133
}
...
!120 = !{!121, !122, i64 16}
!121 = !{!"_ZTS3V3i", !122, i64 0, !122, i64 8, !122, i64 16}
!122 = !{!"long", !123, i64 0}
