...
;; dbg.assign/DIExpression.

; CHECK: %i.sroa.4.12.vec.insert = insertelement <2 x float> %i.sroa.4.0.vec.insert, float %2, i32 1, !dbg
; CHECK-NEXT: call void @llvm.dbg.assign(metadata float %2,{{.+}}, metadata !DIExpression(DW_OP_LLVM_fragment, 96, 32),{{.+}}, metadata <2 x float>* undef), !dbg
...
entry:
  call void @llvm.dbg.assign(metadata i1 undef, metadata !15, metadata !DIExpression(DW_OP_LLVM_fragment, 0, 64), metadata !32, metadata <2 x float>* undef), !dbg !33
  call void @llvm.dbg.assign(metadata i1 undef, metadata !15, metadata !DIExpression(DW_OP_LLVM_fragment, 64, 64), metadata !34, metadata <2 x float>* undef), !dbg !33
  call void @llvm.dbg.assign(metadata i1 undef, metadata !30, metadata !DIExpression(DW_OP_LLVM_fragment, 0, 64), metadata !35, metadata <2 x float>* undef), !dbg !33
  call void @llvm.dbg.assign(metadata i1 undef, metadata !30, metadata !DIExpression(DW_OP_LLVM_fragment, 64, 64), metadata !36, metadata <2 x float>* undef), !dbg !33
  %i = alloca %class.d, align 8, !DIAssignID !37
  call void @llvm.dbg.assign(metadata i1 undef, metadata !31, metadata !DIExpression(), metadata !37, metadata %class.d* %i), !dbg !33
  %ref.tmp = alloca %class.d, align 4
  %call = call { <2 x float>, <2 x float> } @_Z1fv(), !dbg !38
  %0 = extractvalue { <2 x float>, <2 x float> } %call, 0, !dbg !38
  call void @llvm.dbg.assign(metadata <2 x float> %0, metadata !15, metadata !DIExpression(DW_OP_LLVM_fragment, 0, 64), metadata !39, metadata <2 x float>* undef), !dbg !33
  %1 = extractvalue { <2 x float>, <2 x float> } %call, 1, !dbg !38
  call void @llvm.dbg.assign(metadata <2 x float> %1, metadata !15, metadata !DIExpression(DW_OP_LLVM_fragment, 64, 64), metadata !40, metadata <2 x float>* undef), !dbg !33
  call void @llvm.dbg.assign(metadata <2 x float> %0, metadata !30, metadata !DIExpression(DW_OP_LLVM_fragment, 0, 64), metadata !41, metadata <2 x float>* undef), !dbg !33
  call void @llvm.dbg.assign(metadata <2 x float> %1, metadata !30, metadata !DIExpression(DW_OP_LLVM_fragment, 64, 64), metadata !42, metadata <2 x float>* undef), !dbg !33
  %2 = bitcast %class.d* %i to i8*, !dbg !43
  call void @llvm.lifetime.start.p0i8(i64 16, i8* nonnull %2) #5, !dbg !43
  %h.sroa.0.sroa.0.0.h.sroa.0.0..sroa_cast4.sroa_cast = bitcast %class.d* %i to <2 x float>*, !dbg !44
  store <2 x float> %0, <2 x float>* %h.sroa.0.sroa.0.0.h.sroa.0.0..sroa_cast4.sroa_cast, align 8, !dbg !44, !DIAssignID !45
  call void @llvm.dbg.assign(metadata <2 x float> %0, metadata !31, metadata !DIExpression(DW_OP_LLVM_fragment, 0, 64), metadata !45, metadata <2 x float>* %h.sroa.0.sroa.0.0.h.sroa.0.0..sroa_cast4.sroa_cast), !dbg !33
  %h.sroa.0.sroa.4.0.h.sroa.0.0..sroa_cast4.sroa_idx13 = getelementptr inbounds %class.d, %class.d* %i, i64 0, i32 0, i32 0, i64 2, !dbg !44
  %h.sroa.0.sroa.4.0.h.sroa.0.0..sroa_cast4.sroa_cast = bitcast float* %h.sroa.0.sroa.4.0.h.sroa.0.0..sroa_cast4.sroa_idx13 to <2 x float>*, !dbg !44
  store <2 x float> %1, <2 x float>* %h.sroa.0.sroa.4.0.h.sroa.0.0..sroa_cast4.sroa_cast, align 8, !dbg !44, !DIAssignID !46
  call void @llvm.dbg.assign(metadata <2 x float> %1, metadata !31, metadata !DIExpression(DW_OP_LLVM_fragment, 64, 64), metadata !46, metadata <2 x float>* %h.sroa.0.sroa.4.0.h.sroa.0.0..sroa_cast4.sroa_cast), !dbg !33
  call void @llvm.dbg.assign(metadata i1 undef, metadata !47, metadata !DIExpression(), metadata !51, metadata %class.d** undef), !dbg !52
  call void @llvm.dbg.assign(metadata %class.d* %i, metadata !47, metadata !DIExpression(), metadata !54, metadata %class.d** undef), !dbg !52
  %3 = bitcast %class.d* %ref.tmp to i8*, !dbg !55
  call void @llvm.lifetime.start.p0i8(i64 16, i8* nonnull %3) #5, !dbg !55
  call void @llvm.dbg.assign(metadata i1 undef, metadata !56, metadata !DIExpression(), metadata !59, metadata %class.d** undef), !dbg !60
  call void @llvm.dbg.assign(metadata %class.d* %ref.tmp, metadata !56, metadata !DIExpression(), metadata !62, metadata %class.d** undef), !dbg !60
  %4 = load float, float* @c, align 4, !dbg !63, !tbaa !65
  %arrayidx.i = getelementptr inbounds %class.d, %class.d* %ref.tmp, i64 0, i32 0, i32 0, i64 3, !dbg !69
  store float %4, float* %arrayidx.i, align 4, !dbg !70, !tbaa !65
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 8 dereferenceable(16) %2, i8* nonnull align 4 dereferenceable(16) %3, i64 16, i1 false), !dbg !71, !DIAssignID !72
  call void @llvm.dbg.assign(metadata i1 undef, metadata !31, metadata !DIExpression(), metadata !72, metadata i8* %2), !dbg !33
  call void @llvm.lifetime.end.p0i8(i64 16, i8* nonnull %3) #5, !dbg !73
  call void @llvm.lifetime.end.p0i8(i64 16, i8* nonnull %2) #5, !dbg !74
  ret void, !dbg !74
}
...
define linkonce_odr dso_local void @_ZN1d1eEv(%class.d* %this) local_unnamed_addr #3 comdat align 2 !dbg !48 {
entry:
  call void @llvm.dbg.assign(metadata i1 undef, metadata !47, metadata !DIExpression(), metadata !78, metadata %class.d** undef), !dbg !79
  call void @llvm.dbg.assign(metadata %class.d* %this, metadata !47, metadata !DIExpression(), metadata !80, metadata %class.d** undef), !dbg !79
  ret void, !dbg !81
}

; Function Attrs: nounwind uwtable
define linkonce_odr dso_local void @_ZN1dC2Ev(%class.d* %this) unnamed_addr #3 comdat align 2 !dbg !57 {
entry:
  call void @llvm.dbg.assign(metadata i1 undef, metadata !56, metadata !DIExpression(), metadata !82, metadata %class.d** undef), !dbg !83
  call void @llvm.dbg.assign(metadata %class.d* %this, metadata !56, metadata !DIExpression(), metadata !84, metadata %class.d** undef), !dbg !83
  %0 = load float, float* @c, align 4, !dbg !85, !tbaa !65
  %arrayidx = getelementptr inbounds %class.d, %class.d* %this, i64 0, i32 0, i32 0, i64 3, !dbg !86
  store float %0, float* %arrayidx, align 4, !dbg !87, !tbaa !65
  ret void, !dbg !88
}
