...
entry:
  ...
  call void @llvm.dbg.assign(metadata i32 %a, metadata !15, metadata !DIExpression(), metadata !18, metadata i32* undef), !dbg !17
  %0 = load i32, i32* @b, align 4, !dbg !19, !tbaa !21
  %cmp = icmp eq i32 %0, 0, !dbg !25
  br i1 %cmp, label %if.then, label %if.end, !dbg !26

if.then:                                          ; preds = %entry
  tail call void @_Z3extv(), !dbg !27
  %.pre = load i32, i32* @b, align 4, !dbg !28, !tbaa !21
...
if.end:                                           ; preds = %if.then, %entry
  ...
  ;; Added by hand:
  call void @llvm.dbg.assign(metadata i32 undef, metadata !15, metadata !DIExpression(), metadata !30, metadata i32* undef), !dbg !17
call void @llvm.dbg.assign(metadata i32 %add, metadata !15, metadata !DIExpression(), metadata !30, metadata i32* undef), !dbg !17
  ret i32 %add, !dbg !31
}
