...
; CHECK-NEXT: call void @llvm.dbg.assign(metadata i32 2, metadata ![[LOCAL:[0-9]+]], metadata !DIExpression(), metadata ![[MERGED_ID:[0-9]+]], metadata i32* %local), !dbg

; CHECK: if.else:
; CHECK-NEXT: call void @llvm.dbg.assign(metadata i32 2, metadata ![[LOCAL]], metadata !DIExpression(), metadata ![[MERGED_ID]], metadata i32* %local), !dbg
...
if.then:                                          ; preds = %entry
  ...
  store i32 2, i32* %local, align 4, !dbg !26, !tbaa !19, !DIAssignID !27
  call void @llvm.dbg.assign(metadata i32 2, metadata !15, metadata !DIExpression(), metadata !27, metadata i32* %local), !dbg !26
  br label %if.end, !dbg !28

if.else:                                          ; preds = %entry
  store i32 2, i32* %local, align 4, !dbg !29, !tbaa !19, !DIAssignID !31
  call void @llvm.dbg.assign(metadata i32 2, metadata !15, metadata !DIExpression(), metadata !31, metadata i32* %local), !dbg !29
  br label %if.end

if.end:                                           ; preds = %if.else, %if.then
  call void @_Z3escPi(i32* %local), !dbg !32
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %0), !dbg !33
  ret void, !dbg !33
}

declare !dbg !34 dso_local i32 @_Z3getv() local_unnamed_addr
declare !dbg !37 dso_local void @_Z3escPi(i32*) local_unnamed_addr
