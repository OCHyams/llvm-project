...
;;
;; IR generated with:
;; $ clang++ -Xclang -debug-coffee-chat -Xclang -disable-llvm-passes \
;;   test.cpp -g -O2 -o - -S -emit-llvm \
;; | opt -sroa -o - -S
;;
...
define dso_local void @_Z1bPii(i32* %p1, i32 %v1) #0 !dbg !7 {
entry:
  call void @llvm.dbg.assign(metadata i1 undef, metadata !13, metadata !DIExpression(), metadata !15, metadata i32** undef), !dbg !16
  call void @llvm.dbg.assign(metadata i1 undef, metadata !14, metadata !DIExpression(), metadata !17, metadata i32* undef), !dbg !16
  call void @llvm.dbg.assign(metadata i32* %p1, metadata !13, metadata !DIExpression(), metadata !18, metadata i32** undef), !dbg !16
  call void @llvm.dbg.assign(metadata i32 %v1, metadata !14, metadata !DIExpression(), metadata !19, metadata i32* undef), !dbg !16
  call void @_ZL1aPii(i32* %p1, i32 %v1), !dbg !20
  ret void, !dbg !21
}

define internal void @_ZL1aPii(i32* %p2, i32 %v2) #2 !dbg !22 {
entry:
  call void @llvm.dbg.assign(metadata i1 undef, metadata !24, metadata !DIExpression(), metadata !26, metadata i32** undef), !dbg !27
  call void @llvm.dbg.assign(metadata i1 undef, metadata !25, metadata !DIExpression(), metadata !28, metadata i32* undef), !dbg !27
  call void @llvm.dbg.assign(metadata i32* %p2, metadata !24, metadata !DIExpression(), metadata !29, metadata i32** undef), !dbg !27
  call void @llvm.dbg.assign(metadata i32 %v2, metadata !25, metadata !DIExpression(), metadata !30, metadata i32* undef), !dbg !27
  store i32 %v2, i32* %p2, align 4, !dbg !31, !tbaa !32
  ret void, !dbg !36
}
...
; CHECK:       store i32 1, i32* %f1_local, align 4,{{.*}} !DIAssignID ![[ID_1:[0-9]+]]
; CHECK-NEXT:  call void @llvm.dbg.assign(metadata i32 1, metadata ![[f1_local:[0-9]+]], metadata !DIExpression(), metadata ![[ID_1]], metadata i32* %f1_local), !dbg ![[f1_dbg:[0-9]+]]
define dso_local i32 @_Z2f1v() #3 !dbg !37 {
entry:
  %f1_local = alloca i32, align 4, !DIAssignID !42
  call void @llvm.dbg.assign(metadata i1 undef, metadata !41, metadata !DIExpression(), metadata !42, metadata i32* %f1_local), !dbg !43
  %0 = bitcast i32* %f1_local to i8*, !dbg !44
  call void @llvm.lifetime.start.p0i8(i64 4, i8* %0) #5, !dbg !44
  call void @_ZL1aPii(i32* %f1_local, i32 1), !dbg !45
  %1 = load i32, i32* %f1_local, align 4, !dbg !46, !tbaa !32
  %2 = bitcast i32* %f1_local to i8*, !dbg !47
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %2) #5, !dbg !47
  ret i32 %1, !dbg !48
}
...
; CHECK:       store i32 2, i32* %arraydecay, align 4,{{.*}} !DIAssignID ![[ID_2:[0-9]+]]
; CHECK-NEXT:  call void @llvm.dbg.assign(metadata i32 2, metadata ![[f2_local:[0-9]+]], metadata !DIExpression(DW_OP_LLVM_fragment, 0, 32), metadata ![[ID_2]], metadata i32* %arraydecay)
define dso_local i32 @_Z2f2v() #3 !dbg !49 {
entry:
  %f2_local = alloca [2 x i32], align 4, !DIAssignID !55
  call void @llvm.dbg.assign(metadata i1 undef, metadata !51, metadata !DIExpression(), metadata !55, metadata [2 x i32]* %f2_local), !dbg !56
  %0 = bitcast [2 x i32]* %f2_local to i8*, !dbg !57
  call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #5, !dbg !57
  %arraydecay = getelementptr inbounds [2 x i32], [2 x i32]* %f2_local, i64 0, i64 0, !dbg !58
  call void @_ZL1aPii(i32* %arraydecay, i32 2), !dbg !59
  %arrayidx = getelementptr inbounds [2 x i32], [2 x i32]* %f2_local, i64 0, i64 0, !dbg !60
  %1 = load i32, i32* %arrayidx, align 4, !dbg !60, !tbaa !32
  %2 = bitcast [2 x i32]* %f2_local to i8*, !dbg !61
  call void @llvm.lifetime.end.p0i8(i64 8, i8* %2) #5, !dbg !61
  ret i32 %1, !dbg !62
}
...
; CHECK:       store i32 3, i32* %add.ptr, align 4,{{.*}} !DIAssignID ![[ID_3:[0-9]+]]
; CHECK-NEXT:  call void @llvm.dbg.assign(metadata i32 3, metadata ![[f3_local:[0-9]+]], metadata !DIExpression(DW_OP_LLVM_fragment, 32, 32), metadata ![[ID_3]], metadata i32* %add.ptr)
define dso_local i32 @_Z2f3v() #3 !dbg !63 {
entry:
  %f3_local = alloca [2 x i32], align 4, !DIAssignID !66
  call void @llvm.dbg.assign(metadata i1 undef, metadata !65, metadata !DIExpression(), metadata !66, metadata [2 x i32]* %f3_local), !dbg !67
  %0 = bitcast [2 x i32]* %f3_local to i8*, !dbg !68
  call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #5, !dbg !68
  %arraydecay = getelementptr inbounds [2 x i32], [2 x i32]* %f3_local, i64 0, i64 0, !dbg !69
  %add.ptr = getelementptr inbounds i32, i32* %arraydecay, i64 1, !dbg !70
  call void @_ZL1aPii(i32* %add.ptr, i32 3), !dbg !71
  %arrayidx = getelementptr inbounds [2 x i32], [2 x i32]* %f3_local, i64 0, i64 1, !dbg !72
  %1 = load i32, i32* %arrayidx, align 4, !dbg !72, !tbaa !32
  %2 = bitcast [2 x i32]* %f3_local to i8*, !dbg !73
  call void @llvm.lifetime.end.p0i8(i64 8, i8* %2) #5, !dbg !73
  ret i32 %1, !dbg !74
}
...
; CHECK:       store i32 4, i32* %f4_param.addr, align 4,{{.*}} !DIAssignID ![[ID_4:[0-9]+]]
; CHECK-NEXT:  call void @llvm.dbg.assign(metadata i32 4, metadata ![[f4_param:[0-9]+]], metadata !DIExpression(), metadata ![[ID_4]], metadata i32* %f4_param.addr)
define dso_local i32 @_Z2f4i(i32 %f4_param) #3 !dbg !75 {
entry:
  %f4_param.addr = alloca i32, align 4, !DIAssignID !80
  call void @llvm.dbg.assign(metadata i1 undef, metadata !79, metadata !DIExpression(), metadata !80, metadata i32* %f4_param.addr), !dbg !81
  store i32 %f4_param, i32* %f4_param.addr, align 4, !tbaa !32, !DIAssignID !82
  call void @llvm.dbg.assign(metadata i32 %f4_param, metadata !79, metadata !DIExpression(), metadata !82, metadata i32* %f4_param.addr), !dbg !81
  call void @_ZL1aPii(i32* %f4_param.addr, i32 4), !dbg !83
  %0 = load i32, i32* %f4_param.addr, align 4, !dbg !84, !tbaa !32
  ret i32 %0, !dbg !85
}
...
; CHECK-NEXT:  call void @llvm.dbg.assign(metadata i32 5, metadata ![[f5_param:[0-9]+]], metadata !DIExpression(), metadata ![[ID_5]], metadata i32* %f5_param.addr)
define dso_local i32 @_Z2f5i(i32 %f5_param) #3 !dbg !86 {
entry:
  %f5_param.addr = alloca i32, align 4, !DIAssignID !91
  call void @llvm.dbg.assign(metadata i1 undef, metadata !88, metadata !DIExpression(), metadata !91, metadata i32* %f5_param.addr), !dbg !92
  call void @llvm.dbg.assign(metadata i1 undef, metadata !89, metadata !DIExpression(), metadata !93, metadata i32** undef), !dbg !92
  store i32 %f5_param, i32* %f5_param.addr, align 4, !tbaa !32, !DIAssignID !94
  call void @llvm.dbg.assign(metadata i32 %f5_param, metadata !88, metadata !DIExpression(), metadata !94, metadata i32* %f5_param.addr), !dbg !92
  call void @llvm.dbg.assign(metadata i32* %f5_param.addr, metadata !89, metadata !DIExpression(), metadata !95, metadata i32** undef), !dbg !92
  call void @_ZL1aPii(i32* %f5_param.addr, i32 5), !dbg !96
  %0 = load i32, i32* %f5_param.addr, align 4, !dbg !97, !tbaa !32
  ret i32 %0, !dbg !98
}
...
; CHECK:       store i32 6, i32* %f6_local, align 4,{{.*}} !DIAssignID ![[ID_6:[0-9]+]]
; CHECK-NEXT:  call void @llvm.dbg.assign(metadata i32 6, metadata ![[f6_local:[0-9]+]], metadata !DIExpression(), metadata ![[ID_6]], metadata i32* %f6_local)
define dso_local i32 @_Z2f6v() #3 !dbg !99 {
entry:
  %f6_local = alloca i32, align 4, !DIAssignID !102
  call void @llvm.dbg.assign(metadata i1 undef, metadata !101, metadata !DIExpression(), metadata !102, metadata i32* %f6_local), !dbg !103
  %0 = bitcast i32* %f6_local to i8*, !dbg !104
  call void @llvm.lifetime.start.p0i8(i64 4, i8* %0) #5, !dbg !104
  call void @_Z1bPii(i32* %f6_local, i32 6), !dbg !105
  %1 = load i32, i32* %f6_local, align 4, !dbg !106, !tbaa !32
  %2 = bitcast i32* %f6_local to i8*, !dbg !107
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %2) #5, !dbg !107
  ret i32 %1, !dbg !108
}
