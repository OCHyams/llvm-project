...
void ConvertDebugDeclareToDebugValue(DbgVariableInst *DPV, StoreInst *SI,
                                     DIBuilder &Builder);
...
void ConvertDebugDeclareToDebugValue(DbgVariableInst *DPV, LoadInst *LI,
                                     DIBuilder &Builder);
...
void ConvertDebugDeclareToDebugValue(DbgVariableInst *DPV, PHINode *LI,
                                     DIBuilder &Builder);
...
void salvageDebugInfoForDbgValues(Instruction &I,
                                  ...
                                  ArrayRef<DbgVariableInst *> DPInsns);
