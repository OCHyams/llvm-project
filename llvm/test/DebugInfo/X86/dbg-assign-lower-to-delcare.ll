...
entry:
  ...
  call void @_Z12maybe_writesPi(i32* nonnull %local), !dbg !16
  call void @_Z3extiiiiiiiiii(i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9), !dbg !17
  %1 = load i32, i32* %local, align 4, !dbg !18, !tbaa !19
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %0), !dbg !23
  ret i32 %1, !dbg !24
}

declare !dbg !25 dso_local void @_Z12maybe_writesPi(i32*) local_unnamed_addr
