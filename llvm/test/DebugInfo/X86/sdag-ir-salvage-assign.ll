...
next:                                             ; preds = %entry
  tail call void @llvm.dbg.assign(metadata i8* %baz, metadata !15, metadata !DIExpression(), metadata !31, metadata i8* undef), !dbg !30
...
declare void @llvm.dbg.assign(metadata, metadata, metadata, metadata, metadata) #0
