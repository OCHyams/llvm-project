...
;; $ opt -sroa -instcombine -simplifycfg -loop-simplify -lcssa -loop-rotate test.ll -o before.ll -S
...
; CHECK: call void @llvm.dbg.assign(metadata i32 %inc, metadata ![[VAR_C:[0-9]+]], metadata !DIExpression(), metadata ![[ID:[0-9]+]], metadata i32* %c.addr), !dbg
; CHECK-NOT: store i32 %inc, i32* %c.addr
; CHECK: call void @llvm.dbg.assign(metadata i32 %inc, metadata ![[VAR_C]], metadata !DIExpression(), metadata ![[ID]], metadata i32* %c.addr), !dbg
...
entry:
  ...
  call void @llvm.dbg.assign(metadata i32 %c, metadata !12, metadata !DIExpression(), metadata !36, metadata i32* %c.addr), !dbg !13
...
for.inc:                                          ; preds = %for.inc.lr.ph, %for.inc
  ...
  call void @llvm.dbg.assign(metadata i32 %inc, metadata !12, metadata !DIExpression(), metadata !38, metadata i32* %c.addr), !dbg !13
  ...
  call void @llvm.dbg.assign(metadata i32 %inc, metadata !12, metadata !DIExpression(), metadata !37, metadata i32* %c.addr), !dbg !13
