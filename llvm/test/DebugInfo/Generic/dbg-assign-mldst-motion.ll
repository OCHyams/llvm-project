...
;; Check that MergedLoadStoreMotion merges DIAssignID on merged stores.

; CHECK: if.then:
; CHECK: call void @llvm.dbg.assign(metadata float %call2, metadata ![[var:[0-9]+]], metadata !DIExpression(), metadata ![[id:[0-9]+]], metadata float* %2), !dbg
; CHECK: br

; CHECK: if.else:
; CHECK: call void @llvm.dbg.assign(metadata float %call5, metadata ![[var]], metadata !DIExpression(), metadata ![[id]], metadata float* %2), !dbg !48
; CHECK: br

; CHECK: if.end:
; CHECK: store float %call2.sink, float* %2, align 4,{{.+}}!DIAssignID ![[id]]
; CHECK: ret void
...
if.then:                                          ; preds = %entry
  ...
  %ref.tmp.sroa.0.0..sroa_idx = getelementptr inbounds %class.a, %class.a* %o, i64 0, i32 0, !dbg !64
  store float %call2, float* %ref.tmp.sroa.0.0..sroa_idx, align 4, !dbg !64, !tbaa.struct !65, !DIAssignID !68
  call void @llvm.dbg.assign(metadata float %call2, metadata !46, metadata !DIExpression(), metadata !68, metadata float* %ref.tmp.sroa.0.0..sroa_idx), !dbg !48
  br label %if.end, !dbg !69

if.else:                                          ; preds = %entry
  %l = getelementptr inbounds %class.i, %class.i* %this, i64 0, i32 2, !dbg !70
  %call4 = tail call nonnull align 1 dereferenceable(1) %class.c* @_ZN1e1fEv(%class.e* nonnull %l), !dbg !71
  %call5 = tail call float @_ZN1c1dEv(%class.c* nonnull %call4), !dbg !72
  %ref.tmp3.sroa.0.0..sroa_idx = getelementptr inbounds %class.a, %class.a* %o, i64 0, i32 0, !dbg !73
  store float %call5, float* %ref.tmp3.sroa.0.0..sroa_idx, align 4, !dbg !73, !tbaa.struct !65, !DIAssignID !74
  call void @llvm.dbg.assign(metadata float %call5, metadata !46, metadata !DIExpression(), metadata !74, metadata float* %ref.tmp3.sroa.0.0..sroa_idx), !dbg !48
  br label %if.end

if.end:                                           ; preds = %if.else, %if.then
  %j = getelementptr inbounds %class.i, %class.i* %this, i64 0, i32 0, !dbg !75
  call void @_ZN1g1hER1a(%class.g* %j, %class.a* nonnull align 4 dereferenceable(4) %o), !dbg !76
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %0) #4, !dbg !77
  ret void, !dbg !77
}
...
!64 = !DILocation(line: 26, column: 7, scope: !51)
!65 = !{i64 0, i64 4, !66}
!66 = !{!67, !67, i64 0}
!67 = !{!"float", !57, i64 0}
!68 = distinct !DIAssignID()
!69 = !DILocation(line: 26, column: 5, scope: !51)
!70 = !DILocation(line: 28, column: 9, scope: !51)
!71 = !DILocation(line: 28, column: 11, scope: !51)
!72 = !DILocation(line: 28, column: 15, scope: !51)
!73 = !DILocation(line: 28, column: 7, scope: !51)
!74 = distinct !DIAssignID()
!75 = !DILocation(line: 29, column: 3, scope: !7)
!76 = !DILocation(line: 29, column: 5, scope: !7)
!77 = !DILocation(line: 30, column: 1, scope: !7)
