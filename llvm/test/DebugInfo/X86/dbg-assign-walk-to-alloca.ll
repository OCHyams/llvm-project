...
;; Check that we walk back through bitcasts and geps to get to write stack-home
;; DBG_VALUEs in terms of their base storage location and update the
;; DIExpression accordingly.
;;
;; $ cat test.cpp
;; void esc(long* p);
;; struct Ex {
...
;; Plus a redundant cast (%cast) added.
...
entry:
  ...
  call void @llvm.dbg.assign(metadata i1 undef, metadata !12, metadata !DIExpression(), metadata !17, metadata %struct.Ex* %X), !dbg !18
  %0 = bitcast %struct.Ex* %X to i8*, !dbg !19
  %cast = bitcast i8* %0 to %struct.Ex*, !dbg !20
  call void @llvm.lifetime.start.p0i8(i64 16, i8* nonnull %0), !dbg !19
  %B = getelementptr inbounds %struct.Ex, %struct.Ex* %cast, i64 0, i32 1, !dbg !20
  store i64 0, i64* %B, align 8, !dbg !21, !tbaa !22, !DIAssignID !27
  call void @llvm.dbg.assign(metadata i64 0, metadata !12, metadata !DIExpression(DW_OP_LLVM_fragment, 64, 64), metadata !27, metadata i64* %B), !dbg !21
  call void @_Z3escPl(i64* nonnull %B), !dbg !28
  %1 = load i64, i64* %B, align 8, !dbg !29, !tbaa !22
  %add = add nsw i64 %1, 2, !dbg !29
  call void @llvm.dbg.assign(metadata i64 %add, metadata !12, metadata !DIExpression(DW_OP_LLVM_fragment, 64, 64), metadata !30, metadata i64* %B), !dbg !29
  call void @llvm.lifetime.end.p0i8(i64 16, i8* nonnull %0), !dbg !31
  ret i64 %add, !dbg !32
}

declare void @llvm.lifetime.start.p0i8(i64 immarg, i8* nocapture)
declare !dbg !33 dso_local void @_Z3escPl(i64*) local_unnamed_addr
