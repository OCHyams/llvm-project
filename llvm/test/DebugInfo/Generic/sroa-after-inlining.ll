...
;; void l() { k(); }
;;
;; $ clang test.c -Xclang -debug-coffee-chat -O2 -g
;;   ...Verifier assertion failure...
;;   !dbg attachment points at wrong subprogram for function

; CHECK: call void @llvm.dbg.assign(metadata i1 undef, metadata !{{.+}}, metadata !DIExpression(), metadata !{{.+}}, metadata i32* undef), !dbg ![[DBG:[0-9]+]]
...
entry:
  ...
  call void @llvm.dbg.assign(metadata i1 undef, metadata !64, metadata !DIExpression(), metadata !74, metadata %struct.c* %j.i) #5, !dbg !75
  %0 = bitcast %struct.c* %j.i to i8*, !dbg !77
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %0) #5, !dbg !77
  %arrayidx.i.i = getelementptr inbounds %struct.c, %struct.c* %j.i, i64 0, i32 1, i64 0, !dbg !78
  %1 = load i32, i32* %arrayidx.i.i, align 4, !dbg !78, !tbaa !31
  store i32 1, i32* @f, align 4, !dbg !80, !tbaa !31
  store i32 %1, i32* @e, align 4, !dbg !81, !tbaa !31
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %0) #5, !dbg !82
  ret void, !dbg !83
}
...
!14 = !{!"clang version 12.0.0 (https://github.sie.sony.com/gbhyamso/coffee-chat.git 3eebbd2d90d6e56e9ee525e82b4c8cee62c24acb)"}
