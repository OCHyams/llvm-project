...
;; Hand written test because the scenario is unlikely.
;;
;; entry:
;;   memdef 5, !1
;;   dbgdef !1
...
;;   memddef 1, !2  ; <-- Dbg=!1, Stack=!2, Loc=Val(undef) XXX
;;   call
;;   dbgdef !2
;;
...
entry:
  ...
  call void @llvm.dbg.assign(metadata i1 undef, metadata !11, metadata !DIExpression(), metadata !13, metadata i8* %c), !dbg !14
  store i8 5, i8* %c, align 1, !dbg !16, !tbaa !17, !DIAssignID !31
  call void @llvm.dbg.assign(metadata i8 5, metadata !11, metadata !DIExpression(), metadata !31, metadata i8* %c), !dbg !14
  br i1 %cond, label %if.then, label %exit

if.then:
  tail call void (...) @d() #4, !dbg !21
  store i8 0, i8* %c, align 1, !dbg !16, !tbaa !17, !DIAssignID !31
  call void @llvm.dbg.assign(metadata i8 0, metadata !11, metadata !DIExpression(), metadata !31, metadata i8* %c), !dbg !14
  br label %exit

exit:
  store i8 1, i8* %c, align 1, !dbg !16, !tbaa !17, !DIAssignID !20
  tail call void (...) @d() #4, !dbg !21
  call void @llvm.dbg.assign(metadata i8 1, metadata !11, metadata !DIExpression(), metadata !20, metadata i8* %c), !dbg !14
