...
; CHECK: if.then:
; CHECK: call void @llvm.dbg.assign(metadata float %call2, metadata ![[var:[0-9]+]], metadata !DIExpression(), metadata ![[id:[0-9]+]], metadata float* %ref.tmp.sroa.0.0..sroa_idx), !dbg
; CHECK: br label %for.inc

; CHECK: if.else:
; CHECK: call void @llvm.dbg.assign(metadata float %call5, metadata ![[var]], metadata !DIExpression(), metadata ![[id]], metadata float* %ref.tmp.sroa.0.0..sroa_idx), !dbg
; CHECK: br label %for.inc

; CHECK: for.inc:
; CHECK-NEXT: %storemerge = phi float [ %call2, %if.then ], [ %call5, %if.else ]
; CHECK-NEXT: store float %storemerge, float* %ref.tmp.sroa.0.0..sroa_idx, align 4{{.+}}!DIAssignID ![[id]]

; CHECK: if.then.1:
; CHECK: call void @llvm.dbg.assign(metadata float %call2.1, metadata ![[var]], metadata !DIExpression(), metadata ![[id]], metadata float* %ref.tmp.sroa.0.0..sroa_idx), !dbg
; CHECK: br label %for.inc.1

; CHECK: if.else.1:
; CHECK: call void @llvm.dbg.assign(metadata float %call5.1, metadata ![[var]], metadata !DIExpression(), metadata ![[id]], metadata float* %ref.tmp.sroa.0.0..sroa_idx), !dbg
; CHECK: br label %for.inc.1

; CHECK: for.inc.1:
; CHECK-NEXT: %storemerge1 = phi float [ %call2.1, %if.then.1 ], [ %call5.1, %if.else.1 ]
; CHECK-NEXT: store float %storemerge1, float* %ref.tmp.sroa.0.0..sroa_idx, align 4{{.+}}!DIAssignID ![[id]]

; CHECK: if.then.2:
; CHECK: call void @llvm.dbg.assign(metadata float %call2.2, metadata ![[var]], metadata !DIExpression(), metadata ![[id]], metadata float* %ref.tmp.sroa.0.0..sroa_idx), !dbg
; CHECK: br label %for.inc.2

; CHECK: if.else.2:
; CHECK: call void @llvm.dbg.assign(metadata float %call5.2, metadata ![[var]], metadata !DIExpression(), metadata ![[id]], metadata float* %ref.tmp.sroa.0.0..sroa_idx), !dbg
; CHECK:  br label %for.inc.2
...
define dso_local void @_ZN1j1oEv(%class.j* %this) local_unnamed_addr #0 align 2 !dbg !7 {
entry:
  %p = alloca %class.a, align 4, !DIAssignID !49
  call void @llvm.dbg.assign(metadata i1 undef, metadata !48, metadata !DIExpression(), metadata !49, metadata %class.a* %p), !dbg !50
  %0 = bitcast %class.a* %p to i8*, !dbg !51
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %0) #4, !dbg !51
  %n = getelementptr inbounds %class.j, %class.j* %this, i64 0, i32 3
  %l = getelementptr inbounds %class.j, %class.j* %this, i64 0, i32 1
  %ref.tmp.sroa.0.0..sroa_idx = getelementptr inbounds %class.a, %class.a* %p, i64 0, i32 0
  %m = getelementptr inbounds %class.j, %class.j* %this, i64 0, i32 2
  %1 = load i8, i8* %n, align 1, !dbg !52, !tbaa !56, !range !63
  %tobool.not = icmp eq i8 %1, 0, !dbg !52
  br i1 %tobool.not, label %if.else, label %if.then, !dbg !64

if.then:                                          ; preds = %entry
  %call = tail call nonnull align 1 dereferenceable(1) %class.c* @_ZN1e1fEv(%class.e* nonnull %l), !dbg !65
  %call2 = tail call float @_ZN1c1dEv(%class.c* nonnull %call), !dbg !66
  store float %call2, float* %ref.tmp.sroa.0.0..sroa_idx, align 4, !dbg !67, !tbaa.struct !68, !DIAssignID !71
  call void @llvm.dbg.assign(metadata float %call2, metadata !48, metadata !DIExpression(), metadata !71, metadata float* %ref.tmp.sroa.0.0..sroa_idx), !dbg !50
  br label %for.inc, !dbg !72

if.else:                                          ; preds = %entry
  %call4 = tail call nonnull align 1 dereferenceable(1) %class.c* @_ZN1e1fEv(%class.e* nonnull %m), !dbg !73
  %call5 = tail call float @_ZN1c1dEv(%class.c* nonnull %call4), !dbg !74
  store float %call5, float* %ref.tmp.sroa.0.0..sroa_idx, align 4, !dbg !75, !tbaa.struct !68, !DIAssignID !76
  call void @llvm.dbg.assign(metadata float %call5, metadata !48, metadata !DIExpression(), metadata !76, metadata float* %ref.tmp.sroa.0.0..sroa_idx), !dbg !50
  br label %for.inc

for.inc:                                          ; preds = %if.then, %if.else
  %2 = load i8, i8* %n, align 1, !dbg !52, !tbaa !56, !range !63
  %tobool.not.1 = icmp eq i8 %2, 0, !dbg !52
  br i1 %tobool.not.1, label %if.else.1, label %if.then.1, !dbg !64

if.then.1:                                        ; preds = %for.inc
  %call.1 = tail call nonnull align 1 dereferenceable(1) %class.c* @_ZN1e1fEv(%class.e* nonnull %l), !dbg !65
  %call2.1 = tail call float @_ZN1c1dEv(%class.c* nonnull %call.1), !dbg !66
  store float %call2.1, float* %ref.tmp.sroa.0.0..sroa_idx, align 4, !dbg !67, !tbaa.struct !68, !DIAssignID !71
  call void @llvm.dbg.assign(metadata float %call2.1, metadata !48, metadata !DIExpression(), metadata !71, metadata float* %ref.tmp.sroa.0.0..sroa_idx), !dbg !50
  br label %for.inc.1, !dbg !72

if.else.1:                                        ; preds = %for.inc
  %call4.1 = tail call nonnull align 1 dereferenceable(1) %class.c* @_ZN1e1fEv(%class.e* nonnull %m), !dbg !73
  %call5.1 = tail call float @_ZN1c1dEv(%class.c* nonnull %call4.1), !dbg !74
  store float %call5.1, float* %ref.tmp.sroa.0.0..sroa_idx, align 4, !dbg !75, !tbaa.struct !68, !DIAssignID !76
  call void @llvm.dbg.assign(metadata float %call5.1, metadata !48, metadata !DIExpression(), metadata !76, metadata float* %ref.tmp.sroa.0.0..sroa_idx), !dbg !50
  br label %for.inc.1

for.inc.1:                                        ; preds = %if.else.1, %if.then.1
  %3 = load i8, i8* %n, align 1, !dbg !52, !tbaa !56, !range !63
  %tobool.not.2 = icmp eq i8 %3, 0, !dbg !52
  br i1 %tobool.not.2, label %if.else.2, label %if.then.2, !dbg !64

if.then.2:                                        ; preds = %for.inc.1
  %call.2 = tail call nonnull align 1 dereferenceable(1) %class.c* @_ZN1e1fEv(%class.e* nonnull %l), !dbg !65
  %call2.2 = tail call float @_ZN1c1dEv(%class.c* nonnull %call.2), !dbg !66
  store float %call2.2, float* %ref.tmp.sroa.0.0..sroa_idx, align 4, !dbg !67, !tbaa.struct !68, !DIAssignID !71
  call void @llvm.dbg.assign(metadata float %call2.2, metadata !48, metadata !DIExpression(), metadata !71, metadata float* %ref.tmp.sroa.0.0..sroa_idx), !dbg !50
  br label %for.inc.2, !dbg !72

if.else.2:                                        ; preds = %for.inc.1
  %call4.2 = tail call nonnull align 1 dereferenceable(1) %class.c* @_ZN1e1fEv(%class.e* nonnull %m), !dbg !73
  %call5.2 = tail call float @_ZN1c1dEv(%class.c* nonnull %call4.2), !dbg !74
  store float %call5.2, float* %ref.tmp.sroa.0.0..sroa_idx, align 4, !dbg !75, !tbaa.struct !68, !DIAssignID !76
  call void @llvm.dbg.assign(metadata float %call5.2, metadata !48, metadata !DIExpression(), metadata !76, metadata float* %ref.tmp.sroa.0.0..sroa_idx), !dbg !50
  br label %for.inc.2

for.inc.2:                                        ; preds = %if.else.2, %if.then.2
  %k = getelementptr inbounds %class.j, %class.j* %this, i64 0, i32 0, !dbg !77
  call void @_ZN1g1hER1a(%class.g* %k, %class.a* nonnull align 4 dereferenceable(4) %p), !dbg !78
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %0) #4, !dbg !79
  ret void, !dbg !79
}
...
!56 = !{!57, !60, i64 3}
!57 = !{!"_ZTS1j", !58, i64 0, !59, i64 1, !59, i64 2, !60, i64 3}
!58 = !{!"_ZTS1g"}
!59 = !{!"_ZTS1e"}
!60 = !{!"bool", !61, i64 0}
