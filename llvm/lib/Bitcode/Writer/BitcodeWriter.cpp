...
void ModuleBitcodeWriter::writeBlockInfo() {
  ...
  }
  {
    ...
    Abbv->Add(BitCodeAbbrevOp(BitCodeAbbrevOp::VBR, 21)); // dbgloc
    Abbv->Add(BitCodeAbbrevOp(BitCodeAbbrevOp::VBR, 21)); // var
    Abbv->Add(BitCodeAbbrevOp(BitCodeAbbrevOp::VBR, 21)); // expr
