...
entry:
  ...
  store i8 0, i8* %c, align 1, !dbg !16, !tbaa !17, !DIAssignID !20
  call void @llvm.dbg.assign(metadata i8 0, metadata !11, metadata !DIExpression(), metadata !20, metadata i8* %c), !dbg !14
  tail call void (...) @d() #4, !dbg !21

  ; --- VV  Hand written  VV --- ;
  store i8 1, i8* %c, align 1, !dbg !16, !tbaa !17, !DIAssignID !31
  ; Check that a dbg.value(0) is inserted here.
  tail call void (...) @d() #4, !dbg !21
  call void @llvm.dbg.assign(metadata i8 1, metadata !11, metadata !DIExpression(), metadata !31, metadata i8* %c), !dbg !14
  ; --- AA  Hand written  AA --- ;
